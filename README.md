...
A complete, production-ready peer-to-peer chat application with end-to-end encryption, file sharing, voice notes, video/audio calls, random matching, and advanced privacy features.

## ⚡ Quick Start

### **First Time Setup (If no node_modules folder):**
